...
##################################################
#require to use :import matplotlib as plt
print(Border)
...
##################################################
#require to use :from sklearn.model_selection import train_test_split
print(Border)
...
# require to use :from sklearn.tree import DecisionTreeClassifier
